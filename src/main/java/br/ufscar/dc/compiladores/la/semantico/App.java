...
import br.ufscar.dc.compiladores.la.semantico.SemanticoParser.ProgramaContext;
...
public class App {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            SemanticoLexer lex = new SemanticoLexer(cs);
            ...
            while ((t = lex.nextToken()).getType() != Token.EOF) {
                String tnome = SemanticoLexer.VOCABULARY.getDisplayName(t.getType());
            ...
            if (!erroLexico) {
                ...
                SemanticoParser parser = new SemanticoParser(tokens);
