...
public class LaLexer extends Lexer {
	...
	public static final int
		...
		FALSO=36, VERDADEIRO=37, NUMINT=38, NUMREAL=39, IDENT=40, CADEIA=41, COMENTARIO=42, 
		WS=43, MAIOR=44, MAIORIGUAL=45, MENOR=46, MENORIGUAL=47, DIFERENTE=48, 
		IGUAL=49, SOMA=50, SUBTRACAO=51, MULTIPLICACAO=52, DIVICAO=53, DELIM=54, 
		ABREPAR=55, FECHAPAR=56, ABRECAHVE=57, FECHACHAVE=58, VIRGULA=59, ATRIBUICAO=60, 
		ENDERECO=61, PONTO=62, PONTEIRO=63;
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"DECLARE", "ALGORITMO", "INTEIRO", "REAL", "TIPO", "VAR", "LEIA", "ESCREVA", 
			"SE", "ENTAO", "SENAO", "FIM_SE", "ENQUANTO", "FIM_ENQUANTO", "FIM_ALGORITMO", 
			"E", "OU", "LITERAL", "NAO", "LOGICO", "CASO", "FIM_CASO", "SEJA", "PARA", 
			"FIM_PARA", "FACA", "ATE", "REGISTRO", "FIM_REGISTRO", "PROCEDIMENTO", 
			"FIM_PROCEDIMENTO", "RETORNE", "FUNCAO", "FIM_FUNCAO", "CONSTANTE", "FALSO", 
			"VERDADEIRO", "NUMINT", "NUMREAL", "IDENT", "CADEIA", "COMENTARIO", "WS", 
			"MAIOR", "MAIORIGUAL", "MENOR", "MENORIGUAL", "DIFERENTE", "IGUAL", "SOMA", 
			"SUBTRACAO", "MULTIPLICACAO", "DIVICAO", "DELIM", "ABREPAR", "FECHAPAR", 
			"ABRECAHVE", "FECHACHAVE", "VIRGULA", "ATRIBUICAO", "ENDERECO", "PONTO", 
			"PONTEIRO"
		};
	}
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"'falso'", "'verdadeiro'", null, null, null, null, null, null, "'>'", 
			"'>='", "'<'", "'<='", "'<>'", "'='", "'+'", "'-'", "'*'", "'/'", "':'", 
			"'('", "')'", "'['", "']'", "','", "'<-'", "'&'", "'.'", "'^'"
		};
	}
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"CONSTANTE", "FALSO", "VERDADEIRO", "NUMINT", "NUMREAL", "IDENT", "CADEIA", 
			"COMENTARIO", "WS", "MAIOR", "MAIORIGUAL", "MENOR", "MENORIGUAL", "DIFERENTE", 
			"IGUAL", "SOMA", "SUBTRACAO", "MULTIPLICACAO", "DIVICAO", "DELIM", "ABREPAR", 
			"FECHAPAR", "ABRECAHVE", "FECHACHAVE", "VIRGULA", "ATRIBUICAO", "ENDERECO", 
			"PONTO", "PONTEIRO"
		};
	}
