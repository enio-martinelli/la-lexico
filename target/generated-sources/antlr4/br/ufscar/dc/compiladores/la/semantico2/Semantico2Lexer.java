...
public class Semantico2Lexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"VERDADEIRO", "NUM_INT", "NUM_REAL", "IDENT", "WS", "CADEIA", "ERRO_CADEIA", 
			"COMENTARIO", "ERRO_COMENTARIO", "MAIOR", "MAIORIGUAL", "MENOR", "MENORIGUAL", 
			"DIFERENTE", "IGUAL", "SOMA", "SUBTRACAO", "MULTIPLICACAO", "DIVICAO", 
			"MOD", "DELIM", "ABREPAR", "FECHAPAR", "ABRECAHVE", "FECHACHAVE", "VIRGULA", 
			"ATRIBUICAO", "ENDERECO", "INTERVALO", "PONTO", "PONTEIRO", "ERRO"
		};
	}
	...
	public Semantico2Lexer(CharStream input) {
		super(input);
		_interp = new LexerATNSimulator(this,_ATN,_decisionToDFA,_sharedContextCache);
	}

	@Override
	public String getGrammarFileName() { return "Semantico2.g4"; }
